...
def main(args):
    ...
    elif args.whole_data: 
        print('-------whole_data----------')
        train_data = Pic_to_Pic_dataset(args.whole_train_csv, mode='train')
        val_data = Pic_to_Pic_dataset(args.whole_val_csv, mode='val')
        test_data = Pic_to_Pic_dataset(args.whole_test_csv, mode='test')
    elif args.org_data:
        print('-----------org_data-------------')
...
if __name__ == '__main__': 
    ...
    parser.add_argument('-rc', '--random_csv', type=str, default='../../qml-data/csv_files/org_whole_99.csv') 
    ...
    parser.add_argument('-w', '--whole_data', type=int, default=0)
    parser.add_argument('-wtrc', '--whole_train_csv', type=str, default='../../qml-data/csv_files/whole_train_237.csv') 
    parser.add_argument('-wvc', '--whole_val_csv', type=str, default='../../qml-data/csv_files/whole_val_29.csv') 
    parser.add_argument('-wtc', '--whole_test_csv', type=str, default='../../qml-data/csv_files/whole_test_29.csv') 
    parser.add_argument('-o', '--org_data', type=int, default=0)
